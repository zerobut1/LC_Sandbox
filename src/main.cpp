...
int main(int argc, char* argv[])
{
    ...
    Kernel2D raytracing_kernel = [&](ImageFloat image, ImageUInt seed_image, Var<Camera> camera, AccelVar accel, UInt2 resolution) noexcept
    {
    ...
    static constexpr uint2 resolution = make_uint2(2048u);
